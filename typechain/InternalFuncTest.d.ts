...
interface InternalFuncTestInterface extends ethers.utils.Interface {
  functions: {
    "_calcBorrowAmount(tuple)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_calcBorrowAmount",
    values: [
      { a1: BigNumberish; b1: BigNumberish; a2: BigNumberish; b2: BigNumberish }
    ]
  ): string;
  encodeFunctionData(
    functionFragment: "_calcSolutionForQuadratic",
...
export class InternalFuncTest extends Contract {
  ...
  interface: InternalFuncTestInterface;
  ...
  functions: {
    ...
    "_calcBorrowAmount((uint256,uint256,uint256,uint256))"(
      reserves: {
        a1: BigNumberish;
        b1: BigNumberish;
        a2: BigNumberish;
    ...
    "_calcSolutionForQuadratic(int256,int256,int256)"(
      a: BigNumberish,
      b: BigNumberish,
      c: BigNumberish,
      overrides?: CallOverrides
    ...
    _sqrt(n: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
